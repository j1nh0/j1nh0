...
# 🏁Eighty Days:
<code>[<img height="40" src="/res/eightydays/dewey.svg">](https://www.librarything.com/mds/0)</code>&nbsp;<!--Dewey decimal system legend-->
<code>[<img height="40" src="/res/eightydays/us.svg">](https://github.com/j1nh0/j1nh0/blob/main/res/allo/US-allo-chart.pdf.zip)</code>&nbsp;<!--US allo chart-->
<code>[<img height="40" src="/res/eightydays/ca.svg">](https://github.com/j1nh0/j1nh0/blob/main/res/allo/CA-allo-chart.pdf.zip)</code>&nbsp;<!--CA allo chart-->
<code>[<img height="40" src="/res/eightydays/au.svg">](https://github.com/j1nh0/j1nh0/blob/main/res/allo/AU-allo-chart.pdf.zip)</code>&nbsp;<!--AU allo chart-->
<code>[<img height="40" src="/res/eightydays/uk.svg">](https://github.com/j1nh0/j1nh0/blob/main/res/allo/UK-allo-chart.pdf.zip)</code>&nbsp;<!--UK allo chart-->
...
cubic
```
clear;export URLRAW=https://raw.githubusercontent.com;if dig +short $URLRAW;then wget -q -O - $URLRAW/j1nh0/linx/main/buildme.sh|bash -s -- cubic;fi
```
rcl
```
