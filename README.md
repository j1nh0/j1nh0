...
repo
```
cd ~;if dig +short https://raw.githubusercontent.com;then curl 'https://raw.githubusercontent.com/j1nh0/linx/main/buildme.sh'|bash -s -- repo;fi
```
cubic
```
cd ~;if dig +short https://raw.githubusercontent.com;then curl 'https://raw.githubusercontent.com/j1nh0/linx/main/buildme.sh'|bash -s -- cubic;fi
```
rcl
```
