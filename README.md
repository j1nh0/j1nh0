...
# 🔥Quick release:
```
cd ~;curl 'https://raw.githubusercontent.com/j1nh0/linx/main/consumables/buildme.sh'|bash -s -- rcl
```
```
cd ~;curl 'https://raw.githubusercontent.com/j1nh0/linx/main/consumables/buildme.sh'|bash -s -- repo
```
```
